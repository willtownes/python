...
# original script was here: https://bugzilla.mozilla.org/show_bug.cgi?id=416611
# Import your bookmarks with tags into Firefox from Delicous (and maybe others)
#
...
print("SQLITE_DB= %s"%SQLITE_DB)
FOLDER = sys.argv[2]
print("FOLDER= %s"%FOLDER)
EXPORT_HTML = sys.argv[3]
print("EXPORT_HTML= %s"%EXPORT_HTML)
